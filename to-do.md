...
create map examples on its code.md pages 
  - for different values of projection lat/lon, static, width/height, controls, controlslist, lang, <map-caption>, <map-layer> and zoom, controlslist="geolocation" and controlslist="search"
