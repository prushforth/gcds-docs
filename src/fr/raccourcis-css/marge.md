...
shortcutsDescription: |
  La valeur <code>value</code> peut être définie à l'une de nos <a href="{{ '/fr/styles/espacement/' | url }}">unités d'espacement prédéfinies</a> (<code>0</code> - <code>1250</code>) ou <code>auto</code>.
